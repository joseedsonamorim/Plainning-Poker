        ...
        <div style={{
            ...
            >
                ...
                <Flex flex={1} align={{base: 'flex-start', md: 'flex-end'}} direction="column">
                    <Text size="md" fw="bold">Convide jogadores:</Text>
                    <TextInput
                        w={250}
                        value={roomUrl}
                        readOnly
            ...
            {!isVoting() &&
                <Fragment>
                    <Alert mt={20} variant="light" color="blue" title="Nenhum tópico selecionado" icon={<FaRegHourglass size={40}/>}>
                        Aguardando um tópico ser selecionado para iniciar o jogo.
                    </Alert>
                    <div>
                        <Text mt={20} ta="center">Jogadores aguardando:</Text>
                        <SimpleGrid cols={{
                            base: 3,
                ...
                <Fragment>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <Button w={180} size="md" onClick={() => setCompleteTopic(room?.current_topic_id)} color="teal">Finalizar Tópico</Button>
                        </div>

                        <Button mt={5} w={180} onClick={() => toggleVisibility(room?.current_topic_id)} size="md"
                                variant="outline">
                            {areVotesVisible() ? 'Ocultar cartas' : 'Revelar cartas'}
                        </Button>
